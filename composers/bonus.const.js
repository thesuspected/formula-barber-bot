...
<blockquote expandable>❗️Учитываются новые клиенты, которые ранее не пользовались нашими услугами. Бонусы зачисляются на счет в момент предоставления приглашенным реферального кода администратору</blockquote>
